...
public class StandardSplash extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		android.widget.RelativeLayout.LayoutParams lp_rotaters = (android.widget.RelativeLayout.LayoutParams) androids
				.getLayoutParams();
		lp_rotaters.setMargins(screenWidth / 2 - iconOffset, topTotation, 0, 0);
		androids.setLayoutParams(lp_rotaters);
		android.widget.RelativeLayout.LayoutParams lp_rotaters_2 = (android.widget.RelativeLayout.LayoutParams) blackberry
				.getLayoutParams();
		lp_rotaters_2.setMargins(screenWidth / 2 - iconOffset, topTotation, 0,
				0);
		blackberry.setLayoutParams(lp_rotaters_2);
		android.widget.RelativeLayout.LayoutParams lp_rotaters_3 = (android.widget.RelativeLayout.LayoutParams) windows
				.getLayoutParams();
		lp_rotaters_3.setMargins(screenWidth / 2 - iconOffset, topTotation, 0,
				0);
		windows.setLayoutParams(lp_rotaters_3);
		android.widget.RelativeLayout.LayoutParams lp_rotaters_4 = (android.widget.RelativeLayout.LayoutParams) androids
				.getLayoutParams();
		lp_rotaters_4.setMargins(screenWidth / 2 - iconOffset, topTotation, 0,
				0);
		...
		windowsAnimator.setAnimationListener(new AnimationListener() {
			...
			public void onAnimationRepeat(Animation animation) {
				 ...
				 * else { // cell1.bringToFront(); // cell2.bringToFront();
		...
		i = new Interpolator() {
			...
			public float getInterpolation(float prog) {
				...
				if (prog < 0.6) {
					...
					f = 1.0f + 1.6667f * (prog - 0.6f) - 4.16675f
							* (prog - 0.6f) * (prog - 0.6f);
				}// else if (prog > 0.92) {
		...
		Interpolator i2 = new Interpolator() {
			...
			public float getInterpolation(float prog) {
				...
				if (prog < 0.60) {
					...
					// f = 1.0f + 0.83335f * (prog - 0.6f) - 2.083375f * (prog -
					// 0.6f)*(prog-0.6f);
					f = 1.0f + 1.6667f * 0.5f * (prog - 0.6f) - 4.16675f * 0.5f
							* (prog - 0.6f) * (prog - 0.6f);
				}
				return f;
			}
		...
		android.widget.RelativeLayout.LayoutParams lp1 = (android.widget.RelativeLayout.LayoutParams) cell1
				.getLayoutParams();
		lp1.setMargins(left1, top1, 0, 0);
		cell1.setLayoutParams(lp1);

		android.widget.RelativeLayout.LayoutParams lp2 = (android.widget.RelativeLayout.LayoutParams) cell2
				.getLayoutParams();
		lp2.setMargins(left2, top1, 0, 0);
		cell2.setLayoutParams(lp2);

		TranslateAnimation ani = new TranslateAnimation(0, 0,
				-screenHeight / 3, 0);
		...
		TranslateAnimation ani2 = new TranslateAnimation(0, 0,
				2 * screenHeight / 3, 0);
	...
	private void animateName() {
		...
		TranslateAnimation animRight = new TranslateAnimation(self, -1, self,
				0, self, 0, self, 0);
		animRight.setInterpolator(i);
		animRight.setDuration(700);
		TranslateAnimation animLeft = new TranslateAnimation(self, 1, self, 0,
				self, 0, self, 0);
