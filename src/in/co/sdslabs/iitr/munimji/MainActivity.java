...
public class MainActivity extends Activity implements OnClickListener {
	...
	Button AddBuddy, viewer, update, delete, feedback;
	TextView display;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		delete = (Button) findViewById(R.id.bFeedBack);
		delete.setOnClickListener(this);
	...
	public void onClick(android.view.View v) {
		...
		if (id == R.id.bFeedBack) {
			Intent openView3 = new Intent("com.example.munimji.FEEDBACK");
			startActivity(openView3); // initializing FeedBackWizard activity
		}
	}
}